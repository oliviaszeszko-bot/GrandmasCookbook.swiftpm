                    ...
                    VStack(alignment: .leading) {
                        Text("Ingredients")
                            ...
                            HStack{
                                ...
                                Text("15oz.can black beans, drained and rinsed")
                                    .font(.custom("Arial", size: 25))
                            }
                            HStack{
                                Button {
                            ...
                            HStack{
                                ...
                                Text("1 1/2 teaspoon onion powder")
                                    .font(.custom("Arial", size: 25))
                            }
                            HStack{
                                Button {
